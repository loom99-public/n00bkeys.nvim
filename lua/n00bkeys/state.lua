...
---Saves the state in the global _G.n00bkeys.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.n00bkeys.state")

    _G.n00bkeys.state = self
end
...
---Whether the n00bkeys is enabled or not.
---
